...
class Chats extends Component {
    ...
    scheduleNextUpdate =() => {
        ...
        this.timer = setTimeout(()=>{
            ...
            else if(this.state.itemsRendered==18 && !this.state.showButton){
                this.setState({
                    showButton:true
                })
                this.scrollToBot();
        ...
        return (
            ...
            {/* <div className='overlay'>  </div> */}
                        ...
                        >
                            ...
                            {   
                            this.state.itemsRendered==18 && this.state.showButton && this.button1()
                            }
                            {/* {   
