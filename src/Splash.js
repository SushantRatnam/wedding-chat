        ...
        return (
            ...
            {/* ,display:'flex',height:'100vh',flexDirectionz:'column' */}
               ...
               <ReactCSSTransitionGroup 
                                        ...
                                        transitionLeaveTimeout={1000}
                >
                    <h2 style={{fontFamily:'Lora',fontWeight:'300', textShadow: '.5px .5px gray',color:'rgba(57, 74, 132,6 )'}}>Amrutha Weds Sushant</h2>
                    <h3 style={{fontFamily:'Cookie',fontWeight:'400',textShadow: '.5px .5px gray',color:'rgba(57, 74, 132,6 )'}}>#AmruthaWedsSushant</h3>
            </ReactCSSTransitionGroup>
               </div>
            </div>
            </div>
